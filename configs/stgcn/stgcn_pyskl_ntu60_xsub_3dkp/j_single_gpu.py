...
# Official 8-GPU setting is batch 128 and LR 0.1. This is the matching
# single-GPU setting for batch 16.
...
log_level = 'INFO'
work_dir = './work_dirs/stgcn/stgcn_pyskl_ntu60_xsub_3dkp/j_single_gpu'

# NCCL is unavailable in native Windows PyTorch builds.
